    ...
    <>
      <div className="rounded-2xl bg-navy p-6 lg:p-8 flex flex-col lg:flex-row lg:items-center justify-between gap-5">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-white text-navy font-display font-semibold text-sm shrink-0"
        >
          <SparkleIcon size={15} />
      ...
      {open && <ScenarioBriefingModal topicTitle={topicTitle} scenario={scenario} onClose={() => setOpen(false)} />}
    </>
  );
}
