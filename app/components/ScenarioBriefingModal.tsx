...
export function ScenarioBriefingModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-[720px] max-h-[92vh] overflow-y-auto rounded-2xl bg-background-elevated flex flex-col"
      ...
      >
        ...
        <div className="p-5 flex flex-col gap-5">
          ...
          <div className="rounded-xl border border-border p-4 flex flex-col gap-3">
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              <button
                type="button"
                className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full border-[1.5px] border-navy/25 text-navy font-display font-semibold text-[12.5px] shrink-0"
              >
                <SpeakerIcon size={14} />
        ...
        <div className="flex items-center justify-between gap-3 p-5 border-t border-border flex-wrap">
          ...
          <Link
            href="/record"
            className="inline-flex items-center gap-1.5 px-5 py-3 rounded-xl bg-navy text-navy-ink font-display font-semibold text-[13.5px]"
          >
            <VideoIcon size={15} />
